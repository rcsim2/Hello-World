...
- (void)_loadAssets
{
    ...
    // TODO: flip texture
    // DONE
    // NOTE: Have to use an image asset and MTKTextureLoaderOriginTopLeft otherwise no go:
    ...
    @{
      ...
      MTKTextureLoaderOptionOrigin             : MTKTextureLoaderOriginTopLeft // Does not work. Huh???
      };

    _colorMap = [textureLoader newTextureWithName:@"ColorMap" //@"Mir" //@"MirMap" //@"ColorMap"
                                      scaleFactor:1.0
                                           bundle:nil
